label start:
    ...
    show text "Радистов у нас еще не было!" at truecenter with dissolve
    pause 3.0
    hide text
    ...
    andrey "в ГУКе и в Радиофаке.  Есть еще много различных институтов и зданий, связанных с УрФУ, но о них вы узнаете потом."
    ...
    show text "1 Исход (+Anya, +Vladimir)" at truecenter with dissolve
    pause 2.0
    hide text
    ...
    show text "2 исход (+Anya)" at truecenter with dissolve
    pause 1.5
    hide text
    ...
    show text "3 исход (+Vladimir)" at truecenter with dissolve
    pause 1.5
    hide text
    ...
    show text "4 исход" at truecenter with dissolve
    pause 1.0
    hide text
