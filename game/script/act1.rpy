label start:
    ...
    mc "И вот я здесь!" with mc_thoughts

    mc "Так-с, теперь нужно как-то добраться до ВУЗа…" with mc_thoughts
    ...
    mc "Да, далековато… Пожалуй, вызову такси." with mc_thoughts

    show black

    show text "Спустя 30 минут (Едем на такси)" at truecenter

    show collegetown

    mc "Итак, я в Студенческом городке. Пора заселяться!" with mc_thoughts

    show black

    show text "Спустя еще 30 минут (Проходим процесс Заселения)" at truecenter

    show dormitory_corridor

    mc "Документы на проживание у меня, проживание я оплатил - осталось увидеть комнату!" with mc_thoughts

    mc "И, возможно, моего соседа… Лишь бы кто-нибудь нормальный попался…" with mc_thoughts
    ...
    show text "Игрок выбирает себе имя" at truecenter
    ...
    mc "Что же на этот раз?" with mc_thoughts

    show phone2

    "Посмотрев на телефон, ты увидел уведомление"

    mc "Ого, уже даже группу создали. Надо бы почитать, что там творится." with mc_thoughts

    show text "Чат в телефоне" at truecenter
    ...
    show text "ГГ смотрит в зеркало" at truecenter

    show mirror

    mc "Блин, а что, если я как-то не так выгляжу? Волосы нормально уложены? Обувь чистая?" with mc_thoughts
    ...
    show text "спустя 15 минут (Идем в гук)" at truecenter
    ...
    mc "Хех, похоже, мы не одни такие." with mc_thoughts
    ...
    mc "Та-а-ак, это, скорее всего, Андрей." with mc_thoughts
    ...
    show text "Выбор реакции главного героя" at truecenter
    ...
    show text "После выбора" at truecenter
    ...
    show text "Идем в ГУК" at truecenter
    ...
    mc "Вау, ну и красота… Все такое громадное, будто сделано для великанов." with mc_thoughts

    show text "Идем в радик" at truecenter
    ...
    show text "Спустя 15 минут" at truecenter
    ...
    mc "Черт, ну я и дебил…" with mc_thoughts
    ...
    show text "Спустя еще 15 минут" at truecenter
    ...
    show text "Выбор ГГ" at truecenter
    ...
    mc "Так, Андрей там что-то скидывал в группу, надо посмотреть." with mc_thoughts

    "Разблокировав телефон и посмотрев беседу, ты увидел какой-то план."

    show phone

    mc "Ну, делать все равно нечего, схожу-ка я на День первый." with mc_thoughts

    "Прочитав это и полистав чат группы, ты решил пойти спать."

    show text "На следующий день" at truecenter

    show text "хуйня: пиздить гей дизайнера за строку: комната гг"
    ...
    mc "Кампус “Новолькоцовоский”..." with mc_thoughts

    mc "что-то интересное. Жаль нету времени узнать об этом побольше." with mc_thoughts
    ...
    mc "Ого, такая важная фигура нашего института." with mc_thoughts
    ...
    mc "Ну, пойдем изучать это все!" with mc_thoughts
    ...
    show text "Выбор" at truecenter

    show text "Окликнуть Аню(1 выбор)" at truecenter
    ...
    show text "Согласиться (1 выбор) - +репутация у Ани" at truecenter
    ...
    show text "Отказаться (2 выбор)" at truecenter
    ...
    show text "Пройти мимо(2 выбор)" at truecenter
    ...
    show text "(1 выбор +реп от Владимира)" at truecenter
    ...
    show text "Исходы" at truecenter
